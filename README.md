...
> 把地基上的每个词真正讲清楚（包括负载均衡在那条链路上到底在干什么），因为剩下 54 篇全都站在它上面。
...
| 路径 | 适合谁 | 时长 | 04 章 |
|---|---|---|---|
| **[A · 通用 full-stack / 后端](START-HERE.md#3-路径-a四周逐日计划)**（默认） | 大多数人。面 senior 后端 / 全栈 / 平台岗 | 4 周 / 33 个学习日（每天 60–90 min） | ✕ 整章跳过 |
